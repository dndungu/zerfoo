...
TEXT ·q4DotBlockSIMD(SB), NOSPLIT, $0-28
	...
	WORD	$0x0F10A4AA				// SSHLL V10.4S, V5.4H, #0
	WORD	$0x4F10A4AB				// SSHLL2 V11.4S, V5.8H, #0
	WORD	$0x0F10A4CC				// SSHLL V12.4S, V6.4H, #0
	WORD	$0x4F10A4CD				// SSHLL2 V13.4S, V6.8H, #0
	...
	VFMLA	V10.S4, V20.S4, V30.S4
	VFMLA	V11.S4, V21.S4, V31.S4
	VFMLA	V12.S4, V22.S4, V30.S4
	VFMLA	V13.S4, V23.S4, V31.S4
...
row_loop:
	...
	WORD	$0x0F10A4CC				// SSHLL V12.4S, V6.4H, #0
	WORD	$0x4F10A4CD				// SSHLL2 V13.4S, V6.8H, #0
	WORD	$0x4E21D94A				// SCVTF V10.4S
	WORD	$0x4E21D96B				// SCVTF V11.4S
	WORD	$0x4E21D98C				// SCVTF V12.4S
	WORD	$0x4E21D9AD				// SCVTF V13.4S
	...
	WORD	$0x0F10A4AA				// SSHLL V10.4S
	WORD	$0x4F10A4AB				// SSHLL2 V11.4S
	WORD	$0x0F10A4CC				// SSHLL V12.4S
	WORD	$0x4F10A4CD				// SSHLL2 V13.4S
	WORD	$0x4E21D94A				// SCVTF
	WORD	$0x4E21D96B
	WORD	$0x4E21D98C
	WORD	$0x4E21D9AD
